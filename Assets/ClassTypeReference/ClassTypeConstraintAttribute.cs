...
namespace TypeReferences {
	...
	public sealed class ClassExtendsAttribute : ClassTypeConstraintAttribute {
		...
		public override bool IsConstraintSatisfied(Type type) {
            //bool structNotEnum = (BaseType.IsValueType && !BaseType.IsEnum) ? !type.IsEnum : true;
            //bool structNotEnum = (BaseType == typeof(ValueType)) && !type.IsEnum;
            //Debug.Log(BaseType.Name + " " + type.Name + " " + structNotEnum);
            //Debug.LogFormat("{0} {1} {2} {3} {4} ", BaseType.Name, type.Name, BaseType.IsValueType, BaseType.IsEnum, type.IsEnum);
            return base.IsConstraintSatisfied(type) && BaseType.IsAssignableFrom(type) && type != BaseType;// && structNotEnum;
		}
